...
par(mfrow = c(1, 2),
    mar = c(5, 4, 4, 2) + 0.1,
                cex.lab=.8,  # tamaño de etiqueta ejes
...
x=muestra[,2]+100
y=muestra[,1]+100
plot(x,y, pch=19,main="Correlación Rho=-0.9", las=1)
grid()

muestra<-gen.corr.data(-0.7,200)
x=muestra[,2]+100
y=muestra[,1]+100
plot(x,y, pch=19,main="Correlación Rho=-0.70", las=1)
grid()
...
x=muestra[,2]+100
y=muestra[,1]+100
plot(x,y, pch=19,main="Correlación Rho=-0.25", las=1)
grid()

muestra<-gen.corr.data(0,200)
x=muestra[,2]+100
y=muestra[,1]+100
plot(x,y, pch=19,main="Correlación Rho=0", las=1)
grid()
...
x=muestra[,2]+100
y=muestra[,1]+100
plot(x,y, pch=19,main="Correlación Rho=0.60", las=1)
grid()
...
x=muestra[,2]+100
y=muestra[,1]+100
plot(x,y, pch=19,main="Correlación Rho=0.80", las=1)
grid()
...
data:  y ~ x
LM test = 1.4445, df = 1, p-value = 0.2294


	RESET test

data:  y ~ x
RESET = 0.18173, df1 = 1, df2 = 22, p-value = 0.674
