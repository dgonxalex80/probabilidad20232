...
|:--------------|:-----------------------------  |
|**Actividad 421**    |Resuelva las preguntas y problemas planteadas en  el  [**Taller 421**](https://github.com/dgonxalex80/probabilidad20232/blob/main/pdf/Taller412.pdf) y entregue su solución  en formato  pdf en el enlace correspondiente de  Brightspace|
|Trabajo individual |  |
